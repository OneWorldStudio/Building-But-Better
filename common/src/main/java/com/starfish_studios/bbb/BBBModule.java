...
//        );
    ...
    public BBBModule(String modId) {
        ...
        trims = SimpleEntrySet.builder(WoodType.class, "trim",
                        ...
                        w -> new FacingConnectingBlock(BlockBehaviour.Properties.copy(BBBBlocks.OAK_TRIM.get())))
        ...
        beams = SimpleEntrySet.builder(WoodType.class, "beam",
                        ...
                        w -> new RotatedPillarBlock(BlockBehaviour.Properties.copy(BBBBlocks.OAK_BEAM.get())))
        ...
        beamStairs = SimpleEntrySet.builder(WoodType.class, "beam_stairs",
                        ...
                        w -> new StairBlock((Blocks.OAK_PLANKS.defaultBlockState()), BlockBehaviour.Properties.copy(BBBBlocks.OAK_BEAM_STAIRS.get())))
                .addTag(modRes("beams"), Registries.BLOCK)
                .addTag(modRes("beams"), Registries.ITEM)
                .copyParentDrop()
                .defaultRecipe()
        ...
        beamSlabs = SimpleEntrySet.builder(WoodType.class, "beam_slab",
                        ...
                        w -> new FacingSlabBlock(BlockBehaviour.Properties.copy(BBBBlocks.OAK_BEAM_SLAB.get())))
                .addTag(modRes("beams"), Registries.BLOCK)
                .addTag(modRes("beams"), Registries.ITEM)
                .copyParentDrop()
                .defaultRecipe()
        ...
        pallets = SimpleEntrySet.builder(WoodType.class, "pallet",
                        ...
                        w -> new PalletBlock(BlockBehaviour.Properties.copy(BBBBlocks.OAK_PALLET.get())))
        ...
        supports = SimpleEntrySet.builder(WoodType.class, "support",
                        ...
                        w -> new SupportBlock(BlockBehaviour.Properties.copy(BBBBlocks.OAK_SUPPORT.get())))
        ...
        balustrades = SimpleEntrySet.builder(WoodType.class, "balustrade",
                        ...
                        w -> new BalustradeBlock(BlockBehaviour.Properties.copy(BBBBlocks.OAK_BALUSTRADE.get())))
        ...
        walls = SimpleEntrySet.builder(WoodType.class, "wall",
                        ...
                        w -> new WoodenWallBlock(BlockBehaviour.Properties.copy(BBBBlocks.OAK_WALL.get())))
...
//                .addTag(modRes("wooden_walls"), Registries.ITEM)
        ...
        frames = SimpleEntrySet.builder(WoodType.class, "frame",
                        ...
                        w -> new FrameBlock(BlockBehaviour.Properties.copy(BBBBlocks.OAK_FRAME.get())))
        ...
        lanterns = SimpleEntrySet.builder(WoodType.class, "lantern",
                        ...
                        w -> new WoodenLanternBlock(BlockBehaviour.Properties.copy(BBBBlocks.OAK_LANTERN.get())))
...
//        this.addEntry(ladders);
        ...
        lattices = SimpleEntrySet.builder(WoodType.class, "lattice",
                        ...
                        w -> new LatticeBlock(BlockBehaviour.Properties.copy(BBBBlocks.OAK_LATTICE.get())))
