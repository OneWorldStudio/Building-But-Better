        ...
        if (!BBBConfig.disableShiftTooltips) {
            ...
            if (stack.is(BBBTags.BBBItemTags.BALUSTRADES)) {
                if (Screen.hasControlDown()) {
                    ...
                    tooltip.add(Component.literal("[").append(Component.translatable("key.keyboard.left.control")).append(Component.literal("]")).withStyle(ChatFormatting.DARK_GRAY, ChatFormatting.ITALIC));
                }
            }
            ...
            if (stack.is(BBBTags.BBBItemTags.STONE_FENCES)) {
                if (Screen.hasControlDown()) {
                    tooltip.add(Component.translatable("description.bbb.pencil").withStyle(ChatFormatting.BLUE)
                            .append(Component.translatable("description.bbb.stone_fence1").withStyle(ChatFormatting.GRAY)));
                    tooltip.add(Component.translatable("description.bbb.stone_fence2").withStyle(ChatFormatting.GRAY));
                    tooltip.add(Component.translatable("description.bbb.pencil").withStyle(ChatFormatting.BLUE)
                            .append(Component.translatable("description.bbb.stone_fence3").withStyle(ChatFormatting.GRAY)));
            ...
            if (stack.is(BBBTags.BBBItemTags.MOULDINGS)) {
                if (Screen.hasControlDown()) {
                    tooltip.add(Component.translatable("description.bbb.pencil").withStyle(ChatFormatting.BLUE)
                            .append(Component.translatable("description.bbb.moulding1").withStyle(ChatFormatting.GRAY)));
            ...
            if (stack.is(BBBTags.BBBItemTags.SUPPORTS)) {
                if (Screen.hasControlDown()) {
                    tooltip.add(Component.translatable("description.bbb.pencil").withStyle(ChatFormatting.BLUE)
                            .append(Component.translatable("description.bbb.support1").withStyle(ChatFormatting.GRAY)));
                ...
                if (Screen.hasControlDown()) {
                    tooltip.add(Component.translatable("description.bbb.pencil").withStyle(ChatFormatting.BLUE)
                            .append(Component.translatable("description.bbb.pallet1").withStyle(ChatFormatting.GRAY)));
                    tooltip.add(Component.translatable("description.bbb.pallet2").withStyle(ChatFormatting.GRAY));
                    tooltip.add(Component.translatable("description.bbb.pencil").withStyle(ChatFormatting.BLUE)
                            .append(Component.translatable("description.bbb.pallet3").withStyle(ChatFormatting.GRAY)));
                ...
                if (Screen.hasControlDown()) {
                    tooltip.add(Component.translatable("description.bbb.pencil").withStyle(ChatFormatting.BLUE)
                            .append(Component.translatable("description.bbb.ladder1").withStyle(ChatFormatting.GRAY)));
                ...
                if (Screen.hasControlDown()) {
                    tooltip.add(Component.translatable("description.bbb.pencil").withStyle(ChatFormatting.BLUE)
                            .append(Component.translatable("description.bbb.column1").withStyle(ChatFormatting.GRAY)));
                ...
                if (Screen.hasControlDown()) {
                    tooltip.add(Component.translatable("description.bbb.pencil").withStyle(ChatFormatting.BLUE)
                            .append(Component.translatable("description.bbb.layer1").withStyle(ChatFormatting.GRAY)));
                    tooltip.add(Component.translatable("description.bbb.layer2").withStyle(ChatFormatting.GRAY));
                    tooltip.add(Component.translatable("description.bbb.pencil").withStyle(ChatFormatting.BLUE)
                            .append(Component.translatable("description.bbb.layer3").withStyle(ChatFormatting.GRAY)));
                ...
                if (Screen.hasControlDown()) {
                    tooltip.add(Component.translatable("description.bbb.pencil").withStyle(ChatFormatting.BLUE)
                            .append(Component.translatable("description.bbb.frame1").withStyle(ChatFormatting.GRAY)));
                    tooltip.add(Component.translatable("description.bbb.frame2").withStyle(ChatFormatting.GRAY));
                    tooltip.add(Component.translatable("description.bbb.pencil").withStyle(ChatFormatting.BLUE)
                            .append(Component.translatable("description.bbb.frame3").withStyle(ChatFormatting.GRAY)));
